    ...
    defineField({
      ...
      fields: [
        ...
        defineField({
          ...
          description:
            'In the chosen flow direction (horizontal or vertical), does body (rich text and embedded media) or image come first?',
          options: {
            list: [
              {title: 'Body then Image', value: 'textFirst'},
              {title: 'Image then Body', value: 'mediaFirst'},
            ],
            layout: 'radio',
          },
        }),
